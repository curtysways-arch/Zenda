...
import { BusinessMissionService } from './src/lib/growth/businessMissionService.js';
import { publishBusinessEvent } from './src/lib/growth/eventBus.js';
...
async function runTest() {
  ...
  try {
    ...
    await prisma.questParticipant.deleteMany({
      where: { questId: { in: [bmAmount.id, bmQty.id] } }
    });
