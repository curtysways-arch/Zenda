...
export default async function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-violet-200 overflow-x-hidden">
            {/* Top Bar / Announcement */}
            <div className="bg-violet-600 py-2.5 relative z-50">
            ...
            <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-slate-100">
                <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
                    <div className="flex items-center gap-3 group cursor-pointer">
                        <div className="bg-violet-600 p-2 rounded-xl shadow-lg shadow-violet-200 group-hover:rotate-12 transition-transform duration-500 flex items-center justify-center">
                            <ZendaLogo className="text-white animate-pulse" size={20} />
                        </div>
                    ...
                    <div className="hidden lg:flex items-center gap-10 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">
                        ...
                        <a href="#pricing" className="hover:text-violet-600 transition-colors">Precios</a>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Link
                            href="/register"
                            className="bg-slate-900 text-white px-6 py-3 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-violet-600 transition-all shadow-xl shadow-slate-200 hover:shadow-violet-200 active:scale-95"
                        >
            ...
            <header className="relative pt-20 pb-0 overflow-hidden">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full -z-10">
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[120%] h-[120%] bg-[radial-gradient(circle_at_center,rgba(16,185,129,0.08)_0%,transparent_70%)]" />
                </div>

                <div className="max-w-7xl mx-auto px-6 text-center space-y-12">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-violet-50 text-violet-600 rounded-full text-[10px] font-black uppercase tracking-[0.2em] shadow-sm border border-violet-100 animate-in fade-in duration-700">
                        <Zap size={14} fill="currentColor" /> El estándar digital en gestión de citas y reservas
                    </div>
                    ...
                    <h1 className="text-5xl md:text-8xl font-black text-slate-900 tracking-tighter leading-[0.9] italic max-w-5xl mx-auto animate-in slide-in-from-bottom duration-700 delay-100">
                        Gestiona <span className="text-violet-600 not-italic">tus citas</span> <br /> 
                        sin responder <span className="text-violet-600 underline decoration-violet-200">ni un mensaje.</span>
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-6 pt-6 animate-in slide-in-from-bottom duration-700 delay-300">
                        <Link
                            href="/register"
                            className="group flex items-center justify-center gap-3 bg-violet-600 text-white px-12 py-5 rounded-3xl font-black text-sm uppercase tracking-widest hover:bg-violet-700 transition-all shadow-2xl shadow-violet-200 active:scale-95"
                        >
                            Crear mi negocio gratis
                        ...
                        <Link
                            href="/demo-spa"
                            className="flex items-center justify-center gap-3 bg-white text-slate-900 border-2 border-slate-100 px-12 py-5 rounded-3xl font-black text-sm uppercase tracking-widest hover:border-slate-300 transition-all shadow-sm active:scale-95"
                        >
                            <PlayCircle size={18} />
                            Ver demo
                        </Link>
                    ...
                    <div className="relative mt-32 pt-12 animate-in zoom-in duration-1000 delay-500 max-w-5xl mx-auto">
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[140%] h-[140%] -z-10">
                            <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_center,rgba(16,185,129,0.15)_0%,transparent_60%)] animate-pulse-slow" />
                        </div>
                        ...
                        <div className="relative bg-slate-950 rounded-[4rem] p-5 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] border border-white/5 md:scale-110 lg:scale-125 translate-y-24 group transition-all duration-700">
                            <div className="absolute inset-0 bg-gradient-to-br from-violet-500/10 to-transparent rounded-[3.8rem] opacity-0 group-hover:opacity-100 transition-opacity" />
                            
                            <img 
                                src="/hero-spa-mockup.png" 
                                alt="Zenda App Mockup" 
                            ...
                            <div className="absolute -left-16 sm:-left-32 top-1/4 bg-white/90 backdrop-blur-xl p-6 rounded-[2.5rem] shadow-[0_30px_60px_-15px_rgba(16,185,129,0.3)] border border-violet-100 hidden md:flex items-center gap-4 animate-float-slow z-20 hover:scale-105 transition-transform cursor-default">
                                <div className="size-14 bg-violet-600 text-white rounded-2xl flex items-center justify-center shadow-xl shadow-violet-600/30">
                            ...
                            <div className="absolute -right-16 sm:-right-32 bottom-1/4 bg-white/90 backdrop-blur-xl p-6 rounded-[2.5rem] shadow-[0_30px_60px_-15px_rgba(37,211,102,0.2)] border border-violet-50 group/wa animate-float-medium z-20 hover:scale-105 transition-transform cursor-default">
                                <div className="flex items-center gap-4">
                                    <div className="text-right pl-4">
                                        <p className="text-[10px] font-black text-violet-500 uppercase tracking-[0.3em] leading-none mb-1.5 font-bold italic">Auto-Bot ON</p>
                                        <p className="text-2xl font-black text-slate-900 tracking-tighter leading-none uppercase italic">WhatsApp Full</p>
                                    </div>
                                    <div className="size-14 bg-[#25D366] text-white rounded-2xl flex items-center justify-center shadow-xl shadow-violet-400/20 group-hover:rotate-12 transition-transform">
                                        <Smartphone size={24} strokeWidth={3} />
                                    </div>
                                </div>
                                
                                {/* Notificación Bubble */}
                                <div className="absolute -top-3 -left-3 bg-violet-500 text-white text-[9px] font-black px-3 py-1 rounded-full shadow-lg animate-bounce">
                                    NUEVA CITA
                                </div>
                            </div>
                        </div>
                ...
                <div className="relative mt-80 py-24 bg-slate-900 overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
                        <p className="text-[10px] font-black text-violet-500 uppercase tracking-[0.4em] mb-12">Adaptable a múltiples sectores</p>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-20 space-y-4">
                        <div className="flex items-center justify-center gap-2">
                            ...
                            <span className="text-[10px] font-black text-violet-600 uppercase tracking-[0.4em]">Proceso</span>
                            <div className="h-px w-8 bg-violet-600" />
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        <StepCard 
                            ...
                            icon={<Smartphone className="text-violet-600" size={32} />}
                        />
                        <StepCard 
                            number="02"
                        ...
                        <StepCard 
                            ...
                            icon={<BarChart3 className="text-violet-600" size={32} />}
                        />
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="bg-slate-900 rounded-[3rem] p-8 md:p-16 flex flex-col lg:flex-row items-center gap-16 relative shadow-3xl">
                        ...
                        <div className="flex-1 space-y-8 text-center lg:text-left">
                            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-violet-500/10 text-violet-400 rounded-full text-[10px] font-black uppercase tracking-widest border border-violet-500/20">
                            ...
                            <h3 className="text-4xl md:text-6xl font-black text-white italic tracking-tighter leading-none">
                                Zen<span className="text-violet-500 not-italic uppercase">da</span> <br />
                                <span className="text-white not-italic uppercase">Demo</span>
                            </h3>
                            ...
                            <Link 
                                href="/register"
                                className="inline-flex items-center gap-3 bg-violet-600 text-white px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-violet-700 transition-all shadow-xl shadow-violet-900/40 active:scale-95"
                            >
            ...
            <section id="pricing" className="py-24 bg-slate-50 relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch justify-center">
                        {planes.length > 0 ? planes.map((plan: any, index: number) => (
                            <PricingCard 
                                key={plan.id}
                                name={plan.name}
                                price={plan.price}
                    ...
                    <div className="mt-32 grid grid-cols-1 md:grid-cols-3 gap-8 text-center pt-20 border-t border-slate-200">
                        <div className="space-y-2">
                            <p className="text-6xl font-black text-violet-600 tracking-tighter italic">+42%</p>
                        ...
                        <div className="space-y-2">
                            <p className="text-6xl font-black text-slate-900 tracking-tighter italic">0</p>
                        ...
                        <div className="space-y-2">
                            <p className="text-6xl font-black text-violet-600 tracking-tighter italic">100%</p>
                    ...
                    <div className="mt-40 max-w-3xl mx-auto space-y-12">
                        ...
                        <div className="space-y-4">
                            ...
                            <FAQItem 
                                ...
                                answer="No. Zenda es 100% en la nube. Puedes acceder desde el navegador de tu computadora, tablet o celular en cualquier momento." 
                            />
                            <FAQItem 
                    ...
                    <div className="mt-40 text-center py-20 bg-slate-900 rounded-[3.5rem] text-white shadow-3xl shadow-violet-900/10 border border-slate-800 relative overflow-hidden">
                        ...
                        <div className="relative z-10 space-y-8 px-6">
                            ...
                            <div className="flex flex-col sm:flex-row justify-center gap-6 pt-4">
                                <Link 
                                    href="/register"
                                    className="bg-violet-600 text-white px-10 py-5 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-violet-700 transition-all shadow-xl shadow-violet-900/40"
                                >
                                    Empezar ahora mismo
                                </Link>
                                <Link 
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center gap-12 text-center md:text-left">
                        <div className="space-y-6">
                            <div className="flex items-center justify-center md:justify-start gap-3">
                                ...
                                <span className="text-xl font-black text-slate-900 tracking-tight italic uppercase">Zen<span className="text-violet-600">da</span></span>
                            </div>
                        ...
                        <div className="flex gap-12">
                            <div className="space-y-4">
                                ...
                                <ul className="flex flex-col gap-2">
                                    <li><Link href="/privacidad" className="text-xs font-bold text-slate-400 hover:text-violet-600 underline decoration-slate-200">Privacidad</Link></li>
                                    <li><Link href="/terminos" className="text-xs font-bold text-slate-400 hover:text-violet-600 underline decoration-slate-200">Términos</Link></li>
                                </ul>
                            </div>
                            <div className="space-y-4">
                                <p className="text-[10px] font-black text-slate-900 uppercase tracking-widest">Contacto</p>
                                <ul className="flex flex-col gap-2">
                                    <li><Link href="#" className="text-xs font-bold text-slate-400 hover:text-violet-600 underline decoration-slate-200">Soporte</Link></li>
                                    <li><Link href="#" className="text-xs font-bold text-slate-400 hover:text-violet-600 underline decoration-slate-200">WhatsApp</Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div className="mt-20 pt-8 border-t border-slate-50 flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-slate-400 text-[9px] font-black uppercase tracking-[0.3em]">© 2026 Zenda. El estándar en gestión de reservas.</p>
    ...
    return (
        <div className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/50 hover:scale-[1.03] hover:shadow-2xl transition-all duration-500 relative group overflow-hidden">
            ...
            <div className="relative z-10 space-y-6">
                <div className="size-16 bg-violet-50 rounded-2xl flex items-center justify-center shadow-inner group-hover:bg-violet-600 group-hover:text-white transition-colors duration-500">
                    {icon}
                </div>
...
function DemoSlot({ time, status, active }: { time: string, status: string, active?: boolean }) {
    return (
        <div className={`p-4 rounded-2xl flex justify-between items-center transition-all ${active ? 'bg-violet-500/10 border border-violet-500/20' : 'bg-white/5 border border-white/5 opacity-40'}`}>
            <span className="font-black text-white">{time}</span>
            <span className={`text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-lg ${active ? 'bg-violet-500 text-white' : 'bg-slate-700 text-slate-400'}`}>
                {status}
            </span>
        </div>
    );
...
function PricingCard({ name, price, description, features, buttonText, href, featured, trialDays }: any) {
    return (
        <div className={`relative flex flex-col p-10 rounded-[3rem] transition-all duration-500 hover:-translate-y-2 border ${
            ...
            {featured && (
                <div className="absolute -top-5 left-1/2 -translate-x-1/2 bg-violet-500 text-white px-6 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.2em] shadow-xl shadow-violet-500/40 whitespace-nowrap">
                   🔥 Recomendado
                </div>
            )}
            
            <div className="space-y-3 mb-8 text-center px-2">
                <p className={`text-[10px] font-black uppercase tracking-[0.3em] ${featured ? 'text-violet-400' : 'text-slate-400'}`}>{name}</p>
                ...
                {trialDays > 0 && (
                    <div className="bg-violet-500/10 text-violet-500 px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest w-fit mx-auto border border-violet-500/20">
            ...
            <div className="flex-grow space-y-4 mb-10 overflow-hidden">
                {features.map((feature: string, i: number) => (
                    <div key={i} className="flex items-start gap-3 group/feat">
                        <div className={`p-0.5 rounded-full mt-0.5 shrink-0 transition-transform group-hover/feat:scale-110 ${featured ? 'bg-violet-500 text-slate-900' : 'bg-violet-100 text-violet-600'}`}>
            ...
            <Link
                ...
                className={`w-full py-5 rounded-2xl font-black text-xs uppercase tracking-[0.2em] text-center transition-all shadow-lg active:scale-95 ${
                    featured 
                    ? 'bg-white text-slate-900 hover:bg-violet-500 hover:text-white' 
...
function TrustPoint({ text }: { text: string }) {
    return (
        <div className="flex items-center gap-3">
            <div className="size-5 bg-violet-500 rounded-full flex items-center justify-center text-white shrink-0">
                <Check size={12} strokeWidth={4} />
            </div>
            <span className="text-sm font-black text-slate-700 uppercase tracking-tight italic">{text}</span>
        </div>
    );
}
...
function FAQItem({ question, answer }: { question: string, answer: string }) {
    return (
        <div className="bg-white p-6 rounded-[2rem] border border-slate-100 hover:border-violet-200 hover:shadow-xl hover:shadow-violet-500/5 transition-all duration-300 group">
            <h4 className="text-base font-black text-slate-900 group-hover:text-violet-600 transition-colors flex items-center justify-between gap-4">
                {question}
    ...
    return (
        <div className="group relative h-[400px] rounded-[2.5rem] overflow-hidden shadow-2xl transition-all duration-700 hover:-translate-y-4">
            ...
            <div className="absolute inset-0 p-8 flex flex-col justify-end text-left space-y-4">
                <div className="size-12 bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center text-2xl group-hover:bg-violet-600 transition-colors duration-500">
                    {icon}
                </div>
